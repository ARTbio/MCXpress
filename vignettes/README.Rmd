...
```{r Clustering, fig.show='hold', dev="svg"}
...
```{r Biomarkers, fig.height=6, fig.width= 12,results='hide', dev="svg"}
...
```{r GSEA, fig.show='hold', results='hide',dev="svg"}
your_analysis <- GSEA(your_analysis, GMTfile = Hallmark, nperm = 1000)
```
```{r Ranking of Genes, fig.show='hold'}
...
```{r GSEA_Heatmap, fig.show='hold',fig.height=6, fig.width= 12, results='hide', dev="svg"}
