...
```{r, fig.height=6, fig.width= 12,results='hide', dev="svg"}
...
```{r, fig.show='hold', results='hide',dev="svg"}
...
```{r, fig.show='hold',fig.height=6, fig.width= 12, results='hide', dev="svg"}
